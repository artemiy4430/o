...
let button2 = document
	...
	.addEventListener('click', () => {
		...
		document.querySelector('.authorisation_button').style.backgroundColor =
			'white'
			document.querySelector('.authorisation_button').style.color =
				'black'
				document.querySelector('.card').style.backgroundColor =
					'red'
					document.querySelector('.Credit-card_name').style.color = 'black'
					document.querySelector('.modalWindow').style.backgroundColor = 'grey'
	})
let button1 = document
	...
	.addEventListener('click', () => {
		...
		document.querySelector('.authorisation_button').style.backgroundColor =
			'black'
		document.querySelector('.authorisation_button').style.color = 'white'
		document.querySelector('.card').style.backgroundColor = 'blue'
		document.querySelector('.Credit-card_name').style.color = 'white'
		document.querySelector('.modalWindow').style.backgroundColor = 'black'
	})
